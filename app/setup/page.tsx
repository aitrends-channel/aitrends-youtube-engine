    ...
    <div className="min-h-screen flex flex-col" style={{ background: "var(--bg-page)" }}>
      ...
      <main className="flex-1 w-full max-w-2xl mx-auto px-8 py-14">
        ...
        <div className="flex gap-1 mb-10 p-1 rounded-xl"
          style={{ background: "var(--bg-card-subtle)", border: "1px solid var(--bd-7)" }}>
        ...
        {tab === "instructions" && (
          <div className="space-y-8">
            ...
            {/* Step 1 — Anthropic */}
            <div className="p-5 rounded-2xl space-y-4" style={{ background: "var(--bg-card)", border: "1px solid var(--bd-7)" }}>
